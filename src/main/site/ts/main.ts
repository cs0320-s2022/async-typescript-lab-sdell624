...
const sun: HTMLSelectElement = document.getElementById("sun");
const moon: HTMLSelectElement = document.getElementById("moon");
const rising: HTMLSelectElement = document.getElementById("rising");
